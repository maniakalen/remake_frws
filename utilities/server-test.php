...
<div class="h2">ToplistX Server Test Script</div>

<a href="http://manage.aff.biz/z/155/CD3560/" target="_blank" class="vps">
<span>
VPS.net hosting offers a pre-configured setup that has all of the requirements for ToplistX, with prices starting under $20/month<br />
...
<table width="925" align="center" border="1" cellpadding="5" cellspacing="0">
    ...
    <td valign="top">
      ...
      else
      {
          echo "<span class=\"failed\">The PHP shell_exec() function " .
               ($server['safe_mode'] ? "cannot be used because of the safe_mode setting" : "is disabled") . "</span>";
      }
      ?>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td valign="top" width="200">
      If this setting is configured it may prevent the software from
      being able to locate the CLI version of PHP and/or the MySQL command
      line programs which can be used for database backups.
    </td>
    <td valign="top">
      <?php
        ob_start();
