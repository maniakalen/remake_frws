<tr id="<?php echo $item['config_id']; ?>">
  ...
  <td style="text-align: right;" class="last">
    <a href="index.php?r=tlxShScannerHistory&config_id=<?php echo urlencode($item['config_id']); ?>">
    <img src="images/history.png" alt="History" title="History" border="0" class="function"></a>
    <a href="index.php?r=tlxShScannerResults&config_id=<?php echo urlencode($item['config_id']); ?>">
    ...
    <a href="index.php?r=tlxShScannerConfigEdit&config_id=<?php echo urlencode($item['config_id']); ?>" class="window function {title: 'Edit Scanner Configuration'}">
